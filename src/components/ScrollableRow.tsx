        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className='w-12 h-12 bg-white/95 rounded-full shadow-xl flex items-center justify-center hover:bg-white border border-gray-200 transition-colors dark:bg-gray-800/90 dark:hover:bg-gray-700 dark:border-gray-600'
            >
